...
export default function TokenizeAssetMint({
  algorand,
  activeAddress,
  signer,
  enqueueSnackbar,
  onAssetCreated: onAssetCreatedCallback,
  ...
  const copyToClipboard = async (text: string) => {
    try {
      ...
      // Keep behavior: immediately prefill Transfer section with this asset ID
      onPrefillTransferAsset?.(text)
    } catch {
